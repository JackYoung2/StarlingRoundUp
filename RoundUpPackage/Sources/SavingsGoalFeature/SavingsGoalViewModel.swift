...
public class SavingsGoalViewModel: SavingsGoalViewModelProtocol {
    ...
    public var displayedProgress: Float { Float(savingsGoal.savedPercentage ?? 0 / 100) }
    ...
    public var displayedCurrentAmount: String {
        NumberFormatter.formattedCurrencyFrom(
            code: savingsGoal.totalSaved?.currency ?? "", amount: savingsGoal.totalSaved?.minorUnits ?? 0
        ) ?? ""
    }
